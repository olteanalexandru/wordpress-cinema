...
<div class="row">
<div class="col-6">
  <button class="openbtn" id="sheet" onclick="openNav()">Checkout Menu</button>  
  </div><div class="row">
  <button type="button" id="closeButton"class="btn btn-dark btn-remove">X</button>
  </div>
  </div>
</div>
</div></div>
