...
if ( file_put_contents ( "/home/oltean/public_html/wp-content/themes/cinematograf/footer-template2.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/home/oltean/public_html/wp-content/plugins/aceide/backups/themes/cinematograf/footer-template2_2020-06-07-20-03-02.php" ) ) ) ) {
...
<div class="container-fluid cevabot text-secondary copyright">
  ...
  copyright Red Horns <?php echo comicpress_copyright(); ?>
  </div>
  </footer>
  <style>
      .copyright{
