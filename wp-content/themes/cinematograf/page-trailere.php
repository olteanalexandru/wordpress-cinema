...
<h4 class="white"><?php the_title();?> </h4>  ( <?php the_field('release_date'); ?> )</p> 
<p>  <?php  $genre_terms = get_field( 'genre' ); ?>
<?php if ( $genre_terms ): ?>
	<?php foreach ( $genre_terms as $genre_term ): ?>
		<?php echo $genre_term->name; ?>
	<?php endforeach; ?>
<?php endif; ?>  <a href="<?php echo get_permalink( $id ) ?>">view more</a>
</p> 
